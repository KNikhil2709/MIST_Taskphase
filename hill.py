...
def matrix_mod_inv(matrix, modulus):
    ...
    det = int(np.round(np.linalg.det(matrix)))  # Step 1)Find determinant
    det_inv = egcd(det, modulus)[1] % modulus  # Step 2)Find determinant value in a specific modulus (usually length of alphabet)
    matrix_modulus_inv = (
